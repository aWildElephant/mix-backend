...
public final class LD2NExecutor extends LDiNExecutor {

    public LD2NExecutor(WordService wordService, FieldSpecification fieldSpecification, Address address, byte indexSpecification) {
