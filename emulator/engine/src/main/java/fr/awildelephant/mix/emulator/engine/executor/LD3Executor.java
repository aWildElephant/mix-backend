...
public final class LD3Executor extends LDiExecutor {

    public LD3Executor(WordService wordService, FieldSpecification fieldSpecification, Address address, byte indexSpecification) {
        super(wordService, fieldSpecification, address, indexSpecification);
    }

    @Override
    protected SignedTwoBytesRegister register(Machine machine) {
        return machine.registerI3();
    }
}
