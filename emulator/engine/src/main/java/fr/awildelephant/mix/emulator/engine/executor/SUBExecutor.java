...
public final class SUBExecutor extends AbstractOperationExecutor {

    private final FieldSpecification fieldSpecification;
    private final Address address;
    private final byte indexSpecification;

    public SUBExecutor(FieldSpecification fieldSpecification, Address address, byte indexSpecification) {
    ...
    public void accept(Machine machine) {
        ...
        final ComputationResult<Word> computation = MathUtils.subtract(registerAContent, newValue);
